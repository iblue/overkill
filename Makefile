...
overkill: overkill.o features.o deshaker.o mask.o optiflow.o
	$(CC) $(CFLAGS) -o overkill overkill.o features.o deshaker.o mask.o optiflow.o $(LIBS)
...
optiflow.o: optiflow.c optiflow.h
	$(CC) $(CFLAGS) -o optiflow.o -c optiflow.c
